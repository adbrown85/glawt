...
inline void Keyboard::addBindings() {
	...
	// Right arrow
	combo.trigger = TOOLKIT_KEY_RIGHT;
	combo.modifier = TOOLKIT_MOD_NONE;
	combo.action = TOOLKIT_DOWN;
	add(Binding(combo, Command::CIRCLE_RIGHT, 5.0f));
	
	// Down arrow
	combo.trigger = TOOLKIT_KEY_DOWN;
	combo.modifier = TOOLKIT_MOD_NONE;
	combo.action = TOOLKIT_DOWN;
	add(Binding(combo, Command::CIRCLE_DOWN, 5.0f));
	
	// Up arrow
	combo.trigger = TOOLKIT_KEY_UP;
	combo.modifier = TOOLKIT_MOD_NONE;
	combo.action = TOOLKIT_DOWN;
	...
	// Minus
	combo.trigger = TOOLKIT_MINUS;
	combo.modifier = TOOLKIT_MOD_NONE;
	combo.action = TOOLKIT_DOWN;
	add(Binding(combo, Command::ZOOM_OUT, 1.0f));
	
	// Plus
	combo.trigger = TOOLKIT_EQUALS;
	combo.modifier = TOOLKIT_MOD_NONE;
	combo.action = TOOLKIT_DOWN;
	...
	//add(Binding('Q', TOOLKIT_MOD_CONTROL, Command::EXIT));
	//add(Binding(TOOLKIT_KEY_HOME, 0, Command::RESET));
